...
// v5的写法，也可以支持es的5.x 6.x

const configs = [
  {host: '127.0.0.1:6800', version: '6.x', index: 'one_piece'},
  {host: 'elastic:changeme@127.0.0.1:5300', version: '5.3', index: 'one_piece'},
];

configs.forEach(test);

function test(config) {
  const client = new easyES(config.host, config.version, config.index);
